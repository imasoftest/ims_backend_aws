...
# class PresetAppointmentSerializer(serializers.ModelSerializer):
#     presetInfo = Base64ImageField(required=False)
#     timerange =
#     class Meta:
#         model = PresetAppointment
#         fields = '__all__'
...
class PresetAppointmentSerializer(serializers.ModelSerializer):
    ...
    # def create(self, validated_data):
    #     appointment_data = super(PresetAppointmentSerializer, self.serializer_class).create(**validated_data)
    #     session_data = {
    #         "appointment":appointment_data.id
    #     }
    #     SessionSerializer.create(self,session_data)
...
class SessionSerializer(serializers.ModelSerializer):
    class Meta:
        model = PresetAppointmentSessions
        fields = '__all__'